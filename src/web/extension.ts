...
export function activate(context: vscode.ExtensionContext) {
  ...
  const testSerial = vscode.commands.registerCommand(
    'helloworld-web-sample.testSerial',
    async () => {
      ...
      console.log(ports);
      vscode.window.showInformationMessage('ports:' + ports);
    }
  );

  context.subscriptions.push(testSerial);
}
